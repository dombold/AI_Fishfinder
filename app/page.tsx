  ...
  return (
    <div style={{ minHeight: '100vh', background: 'radial-gradient(ellipse at 70% 0%, #0E2A45 0%, #0B1929 50%, #061018 100%)', display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '5rem 2rem 3rem', textAlign: 'center' }}>
        ...
        {/* Feature strip */}
        <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.25rem', maxWidth: '860px', width: '100%', padding: '3rem 0 0' }}>
        ...
        {/* Product screenshots */}
        <section style={{ maxWidth: '1000px', width: '100%', margin: '5rem auto 0', padding: '0' }}>
          <p style={{ color: 'var(--color-seafoam)', fontSize: '0.8125rem', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', textAlign: 'center', marginBottom: '0.75rem' }}>
            See It In Action
          </p>
          <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(1.5rem, 3vw, 2rem)', color: 'var(--color-foam)', textAlign: 'center', letterSpacing: '-0.03em', marginBottom: '3rem' }}>
            From plan to chartplotter in minutes
          </h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', alignItems: 'start' }}>
            <div>
              <p style={{ color: 'var(--color-mist)', fontSize: '0.8125rem', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.75rem' }}>Create your plan</p>
              <div style={{ borderRadius: '0.75rem', overflow: 'hidden', border: '1px solid rgba(107,143,163,0.2)', boxShadow: '0 8px 32px rgba(0,0,0,0.4), 0 0 0 1px rgba(59,191,174,0.05)' }}>
                <img src="/preview-planner.png" alt="AI Fishfinder plan creation" style={{ width: '100%', display: 'block' }} />
              </div>
            </div>
            <div>
              <p style={{ color: 'var(--color-mist)', fontSize: '0.8125rem', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.75rem' }}>Your daily briefing</p>
              <div style={{ borderRadius: '0.75rem', overflow: 'hidden', border: '1px solid rgba(107,143,163,0.2)', boxShadow: '0 8px 32px rgba(0,0,0,0.4), 0 0 0 1px rgba(59,191,174,0.05)' }}>
                <img src="/preview-brief.png" alt="AI Fishfinder fishing brief" style={{ width: '100%', display: 'block' }} />
              </div>
            </div>
          </div>
        </section>
